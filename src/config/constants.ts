...
export const ERROR_MESSAGES = {
  ...
  INVALID_TOKEN_FORMAT: '[Invalid Parameter] <token> must be a valid GitHub token (ghp_, ghs_, or github_pat_)',
  INVALID_OWNER: '[Invalid Parameter] <owner> must be provided',
  INVALID_OWNER_FORMAT: '[Invalid Parameter] <owner> must be a valid GitHub username or organization',
  INVALID_REPO: '[Invalid Parameter] <repo> must be provided',
  INVALID_REPO_FORMAT: '[Invalid Parameter] <repo> must be a valid GitHub repository name',
  INVALID_RUNS_TO_KEEP: '[Invalid Parameter] <runs_to_keep> must be a valid integer',
  INVALID_RUNS_TO_KEEP_NEGATIVE: '[Invalid Parameter] <runs_to_keep> must be non-negative',
  INVALID_RUNS_TO_KEEP_MAX: '[Invalid Parameter] <runs_to_keep> must be less than or equal to 10000',
  INVALID_RUNS_OLDER_THAN: '[Invalid Parameter] <runs_older_than> must be a valid integer',
  INVALID_RUNS_OLDER_THAN_NEGATIVE: '[Invalid Parameter] <runs_older_than> must be non-negative',
  INVALID_RUNS_OLDER_THAN_MAX: '[Invalid Parameter] <runs_older_than> must be less than or equal to 3650 days',
  INVALID_DRY_RUN: '[Invalid Parameter] <dry_run> must be a boolean value (true/false, yes/no, 1/0)',
} as const;
